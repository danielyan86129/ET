// Implementation of the QT based UI window class
// 
...
{
	QString ma_file = QFileDialog::getOpenFileName( this, "Select medial axis file", "", "*.off *.ply *.ma",
		NULL/*, QFileDialog::DontUseNativeDialog*/ );
	ui_compact.maFileEdit->setText( ma_file );
}
void ETMainWindow::onBrowseOrigClicked()
{
	QString shape_file = QFileDialog::getOpenFileName( this, "Select original 3d shape file", "", "*.off *.ply",
		NULL/*, QFileDialog::DontUseNativeDialog*/ );
